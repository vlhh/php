<?php
/**
 * UNIVATES - Programação para Internet
 * @author Jonas Dhein
 *
...
"<link rel='icon' href='https://icon-library.com/images/php-icon/php-icon-8.jpg'/>";

$header = "<img class='logofsphp' src='https://www.univates.br/media/institucional/img/logotipo1.png'/>";
echo $header;
...
{
    echo "<title>{$className} | PHP</title>";
}
